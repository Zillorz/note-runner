A very simple program used to run snippets of C code in markdown for my CMSC216 notes.
...
Must be used with GNU GCC if you want nested functions, on MacOS, the `gcc` command forwards to clang by default.
